...
RUN apt-get update 
RUN apt-get install -y --no-install-recommends curl gnupg apt-utils apache2 \
    software-properties-common ca-certificates lsb-release apt-transport-https 
RUN add-apt-repository ppa:ondrej/php 
RUN apt-get install -y php7.3
RUN apt-get install -y php7.3-bcmath php7.3-bz2 php7.3-curl php7.3-dom php7.3-enchant \
    php7.3-gd php7.3-gmp php7.3-imagick php7.3-intl php7.3-ldap php7.3-mbstring \
    php7.3-mysqli php7.3-mysqlnd php7.3-pdo-mysql php7.3-pdo-pgsql php7.3-pgsql \ 
    php7.3-SimpleXML php7.3-tidy php7.3-wddx php7.3-xml php7.3-xmlreader php7.3-xmlwriter \
